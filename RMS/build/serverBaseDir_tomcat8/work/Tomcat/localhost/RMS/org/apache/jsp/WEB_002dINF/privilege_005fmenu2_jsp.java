 ...
 * Generated at: 2016-12-01 06:11:06 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t        {field:'PrivilegeOperation',title:'菜单-按钮',width:180},\r\n");
      out.write("\t\t\t        {field:'RecordStatus',title:'编码',width:180}, \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t $.messager.alert('错误','分配权限出错！'+'已存在'+errori+'条权限','error'); \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t }\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t else{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t $.messager.alert('提示','分配权限成功！'+'新增'+successi+'条！'+'修改'+updatei+'条！'+'失败'+errori+'条!','info'); \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t }\r\n");
      out.write("\t        \t\t\t\t\t        \t\r\n");
      out.write("\t        \t\t\t\t\t         }\r\n");
      out.write("\t        \t\t\t\t\t         \r\n");
      ...
      out.write("    \t\t\t\t\t                priKey: priKey.id,\t        \t\t\t\t\t                \t        \t\t\t\t\t                \r\n");
      out.write("    \t\t\t\t\t         },                              \r\n");
      out.write("    \t\t\t\t\t         success: function(returnpd){\r\n");
      out.write("    \t\t\t\t\t        \t alert(returnpd)\r\n");
      out.write("    \t\t\t\t\t        \t    \r\n");
      out.write("    \t\t\t\t\t         }\r\n");
      out.write("    \t\t\t\t\t         \r\n");
      out.write("    \t\t\t\t\t   \t\t });\t        \t\t\t\t\t\t\t\r\n");
      ...
      out.write("    \t<table id=\"pritt\" style=\"width:600px;height:400px\"></table>  \r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
