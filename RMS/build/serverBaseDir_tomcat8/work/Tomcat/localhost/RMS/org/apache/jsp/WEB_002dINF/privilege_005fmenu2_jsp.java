 ...
 * Generated at: 2016-12-01 12:23:19 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t if(returnpd == \"error\"){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t $.messager.alert('错误','禁用权限出错！'+'禁用成功'+successi+'条！'+'失败'+errori+'条权限','error'); \r\n");
      out.write("\t\t\t\t\t\t\t\t\t }\r\n");
      out.write("\t\t\t\t\t\t\t\t\t else{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t $.messager.alert('提示','禁用权限成功！'+'禁用成功'+successi+'条！'+'失败'+errori+'条!','info'); \r\n");
      out.write("\t\t\t\t\t\t\t\t\t }\r\n");
      out.write("\t\t\t\t\t\t\t\t\t \r\n");
      out.write("    \t\t\t\t\t        \t\r\n");
      out.write("    \t\t\t\t\t         }\r\n");
