 ...
 * Generated at: 2016-11-23 13:44:29 UTC
...
return;
    ...
    try {
      ...
      out.write(" \t\t\t    url:'getAll_Role.action',\r\n");
      ...
      out.write(" \t\t\t   \tsingleSelect:true, \t\t\t    \r\n");
      out.write(" \t\t\t    columns:[[\r\n");
      out.write(" \t\t\t\t\t{field:'RoleName',title:'账号',width:300,align:'center'},\r\n");
      out.write(" \t\t\t\t\t{field:'RoleDesc',title:'名称',width:300,align:'center'}\r\n");
      out.write(" \t\t\t    ]],\r\n");
      out.write(" \t\t\t //数据表格  \r\n");
      out.write(" \t\t\t   toolbar: [{\r\n");
      out.write(" \t\t\t\t  \ttext:'角色',\r\n");
      out.write("\t\t\t\t\ticonCls: 'icon-customer2',\r\n");
      out.write("\t\t\t\t\thandler: $('#usersdg').hide()\r\n");
      out.write(" \t\t\t\t  \t\r\n");
      out.write(" \t\t\t\t},'-',{\r\n");
      out.write(" \t\t\t\t\ttext:'用户',\r\n");
      out.write(" \t\t\t\t\ticonCls: 'icon-users',\r\n");
      out.write(" \t\t\t\t\thandler: $('#roledg').hide()\r\n");
      out.write(" \t\t\t\t}]\r\n");
      out.write("\r\n");
      out.write(" \t\t\t});\r\n");
      out.write(" \t\t});\r\n");
      ...
      out.write(" \t\t\tvar a=null;\r\n");
      out.write(" \t\t\t//数据表格\r\n");
      out.write(" \t\t\t$('#privilegedg').datagrid({\r\n");
      out.write(" \t\t\t    url:'getallgood.action?gname='+a,\r\n");
      out.write(" \t\t\t   \tpagination:true,\r\n");
      out.write(" \t\t\t   \trownumbers:true,\r\n");
      out.write(" \t\t\t   \tstriped:true,\r\n");
      out.write(" \t\t\t   \tsingleSelect:true, \t\t\t    \r\n");
      out.write(" \t\t\t    columns:[[\r\n");
      out.write(" \t\t\t\t\t{field:'distribution',title:'分配权限',width:80,align:'center'},\r\n");
      out.write(" \t\t\t\t\t{field:'forbid',title:'禁止权限',width:80,align:'center'},\r\n");
      out.write(" \t\t\t\t\t{field:'menuBtn',title:'菜单-按钮',width:300,align:'center'},\r\n");
      out.write(" \t\t\t\t\t{field:'code',title:'编码',width:300,align:'center'},\r\n");
      out.write(" \t\t\t\t\t{field:'MenuIcon',title:'图标',width:300,align:'center'}\r\n");
      out.write(" \t\t\t    ]],\r\n");
      out.write("\r\n");
      out.write(" \t\t\t});\r\n");
      out.write(" \t\t});\r\n");
