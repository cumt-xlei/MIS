	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 loginCenter">
				...
				<form class="form-horizontal" action="search.action" role="form" method="post">
   				...
   				<div class="form-group">
     				 <div class="col-sm-12">
         				<button type="submit" class="btn btn-primary">立即找回</button>
      				 </div> 
   				</div>
			     </form>
                 ...
                 <div class="ohterHelp row">
                    ...
                    <div class="col-sm-4 registerLogin"><hr class="fl" /><a href="updateUser">或者修改密码</a><hr class="fr" /></div>
                    <div class="col-sm-4"></div>              
                 </div>
